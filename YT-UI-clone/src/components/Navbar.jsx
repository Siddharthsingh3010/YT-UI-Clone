...
const Navbar = () => {
  ...
  return (
    <div className=" flex justify-between px-5 py-1 fixed top-0 z-10 bg-white w-[100%] font-roboto">
      ...
      <div className="flex w-[45%] items-center">
        <div className="w-[100%] py-2 px-4 border border-gray-400 rounded-full p-2 rounded-r-none text-black">
          <input
            value={input}
